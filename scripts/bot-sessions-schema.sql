...
-- INSERT INTO bot_sessions.sessions (session_id, bot_id, meeting_id, meeting_title, status, start_time, target_languages)
-- VALUES ('test_session_001', 'bot_001', 'meeting_001', 'Test Meeting', 'active', NOW(), '["en", "es", "fr"]'::jsonb);

COMMENT ON SCHEMA bot_sessions IS 'Comprehensive schema for managing Google Meet bot sessions with audio, transcripts, translations, and correlations';
