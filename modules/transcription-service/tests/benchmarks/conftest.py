...
Benchmark tests load SessionRestartTranscriber per test class via yield fixtures.
...
def _gc_after_benchmark_test():
    """GC + MPS cache flush after every benchmark test."""
    yield
    gc.collect()
    _empty_device_cache()
