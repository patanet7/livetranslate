...
def test_streaming_simulation():
    ...
    try:
        ...
        print("   (Waiting 10 seconds to ensure all chunks are processed...)")
        time.sleep(10.0)
        ...
        if results:
            ...
            # Success criteria
            passed = (
                len(results) > 0  # Got results
                and found_count >= 2  # Found at least 2 JFK keywords
                and (draft_count > 0 or final_count > 0)  # Got streaming markers
            )
