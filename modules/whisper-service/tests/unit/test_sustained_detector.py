...
from language_id import SustainedLanguageDetector, LanguageSwitchEvent
...
class TestHysteresisPreventsFlapping:
    ...
    def test_prevents_rapid_en_zh_en_zh_flapping(self, detector):
        ...
        assert switches_detected == 0, f"Flapping should not trigger switches, got {switches_detected}"
...
class TestFalsePositivePrevention:
    ...
    def test_tracks_false_positives_prevented(self, detector):
        ...
        logger.info(
            f"✅ False positives tracked: {detector.false_positives_prevented}"
        )
...
class TestAdaptiveThresholds:
    ...
    def test_configurable_confidence_margin(self):
        ...
        for i in range(1, 10):
            ...
            event = strict.update({'en': 0.35, 'zh': 0.65}, timestamp=i * 0.1)
...
class TestMultiLanguageSupport:
    ...
    def test_three_language_detection(self):
        ...
        for i in range(1, 10):
            event = detector.update({'en': 0.1, 'zh': 0.2, 'es': 0.7}, timestamp=i * 0.1)
    ...
    def test_selects_max_probability_language(self):
        ...
        for i in range(1, 10):
            event = detector.update({'en': 0.1, 'zh': 0.1, 'es': 0.1, 'fr': 0.7}, timestamp=i * 0.1)
