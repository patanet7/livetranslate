...
class TestWebSocketError:
    ...
    def test_websocket_error_initialization(self):
        ...
        error = WebSocketError(
            error_type=ErrorType.CONNECTION_ERROR, message="Test error", details={"key": "value"}
        )
    ...
    def test_websocket_error_str_representation(self):
        ...
        error = WebSocketError(error_type=ErrorType.AUTHENTICATION_ERROR, message="Auth failed")
...
class TestComponentIntegration:
    ...
    def test_connection_manager_error_handler_integration(self):
        ...
        error = WebSocketError(
            error_type=ErrorType.CONNECTION_ERROR, message="Connection limit exceeded"
        )
...
class TestComponentPerformance:
    ...
    def test_error_handler_performance(self):
        ...
        # Handle 1000 errors
        for i in range(1000):
            error = WebSocketError(error_type=ErrorType.MESSAGE_ERROR, message=f"Error {i}")
