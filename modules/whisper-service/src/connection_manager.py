...
class ConnectionPool:
    ...
    def get_connection_info(
        self, sid: str, client_ip: str, user_agent: str = "", user_id: str | None = None
    ) -> ConnectionInfo:
...
class ConnectionManager:
        ...
        with self._lock:
            ...
            if self.connection_pool:
                connection = self.connection_pool.get_connection_info(
                    sid=sid, client_ip=client_ip, user_agent=user_agent, user_id=user_id
                )
                self.pool_hits += 1
            else:
    ...
    def remove_connection(self, sid: str) -> ConnectionInfo | None:
        """
            ...
            return {
                ...
                "performance_metrics": {
                    ...
                    "memory_usage": {
                        ...
                        "pool_max_size": self.connection_pool.max_pool_size
                        if self.connection_pool
                        else 0,
                    },
                },
