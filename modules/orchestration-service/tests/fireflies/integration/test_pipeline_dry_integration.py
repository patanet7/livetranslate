...
class TestUnifiedPipelineFormat:
    ...
    def test_transcript_chunk_has_required_fields(self):
        ...
        from services.pipeline.adapters import AudioUploadChunkAdapter, TranscriptChunk
...
class TestSessionsAPIEndpoint:
    ...
    def test_sessions_response_model(self):
        ...
        from routers.data_query import SessionSummary, SessionsListResponse
...
class TestEndToEndPipelineFlow:
    ...
    async def test_fireflies_import_full_flow(self):
        ...
        sentences = [
            {"text": "Welcome to the meeting", "speaker_name": "Host", "start_time": 0, "end_time": 2},
            {"text": "Thank you for joining", "speaker_name": "Host", "start_time": 2, "end_time": 4},
