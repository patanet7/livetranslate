...
class TestPipelineBatchProcessing:
    ...
    def test_process_pipeline_with_noise_reduction(self, client, test_audio_file, noise_reduction_pipeline_config):
    ...
    def test_process_pipeline_different_formats(self, client, test_audio_file, simple_pipeline_config):
...
class TestRealtimeSessionManagement:
    ...
    def test_start_realtime_session_invalid_config(self, client):
        ...
        response = client.post(
            "/api/pipeline/realtime/start",
            json={"pipeline_config": invalid_config}
        )
    ...
    def test_stop_realtime_session(self, client, simple_pipeline_config):
        ...
        stop_response = client.post(
            f"/api/pipeline/realtime/stop/{session_id}"
        )
    ...
    def test_stop_nonexistent_session(self, client):
        ...
        response = client.post(
            "/api/pipeline/realtime/stop/nonexistent-session-id"
        )
...
class TestPipelineValidation:
    ...
    def test_validate_circular_dependencies(self, client):
        ...
        response = client.post(
            "/api/pipeline/validate",
            json={"pipeline_config": circular_config}
        )
...
class TestConcurrentSessions:
    ...
    def test_session_isolation(self, client, simple_pipeline_config):
        ...
        response1 = client.post(
            "/api/pipeline/realtime/start",
            json={"pipeline_config": config1}
        )
        response2 = client.post(
            "/api/pipeline/realtime/start",
            json={"pipeline_config": config2}
        )
...
class TestPipelineMetrics:
    ...
    def test_metrics_included_in_response(self, client, test_audio_file, noise_reduction_pipeline_config):
