...
def upgrade() -> None:
    ...
    op.create_index('ix_domain_categories_usage', 'domain_categories', ['usage_count'], unique=False)
    ...
    op.create_index('ix_conv_sessions_last_message_at', 'conversation_sessions', ['last_message_at'], unique=False)
    op.create_index('ix_conv_sessions_metadata_gin', 'conversation_sessions', ['session_metadata'], unique=False, postgresql_using='gin')
    op.create_index('ix_conv_sessions_session_type', 'conversation_sessions', ['session_type'], unique=False)
    op.create_index('ix_conv_sessions_started_at', 'conversation_sessions', ['started_at'], unique=False)
    op.create_index('ix_conv_sessions_user_started', 'conversation_sessions', ['user_id', 'started_at'], unique=False)
    op.create_index(op.f('ix_conversation_sessions_user_id'), 'conversation_sessions', ['user_id'], unique=False)
    op.create_table('domain_prompts',
    ...
    op.create_table('domain_terminology',
    ...
    op.create_index('ix_domain_terminology_domain_importance', 'domain_terminology', ['domain_id', 'importance'], unique=False)
    op.create_index('ix_domain_terminology_importance', 'domain_terminology', ['importance'], unique=False)
    op.create_index('ix_domain_terminology_normalized', 'domain_terminology', ['normalized_term'], unique=False)
    ...
    op.create_index('ix_user_domain_prefs_domain', 'user_domain_preferences', ['domain_id'], unique=False)
    op.create_index('ix_user_domain_prefs_user', 'user_domain_preferences', ['user_id'], unique=False)
    op.create_index('ix_user_domain_prefs_user_domain', 'user_domain_preferences', ['user_id', 'domain_id'], unique=True)
    ...
    op.create_index('ix_chat_messages_content_fulltext', 'chat_messages', ['content'], unique=False, postgresql_using='gin', postgresql_ops={'content': 'gin_trgm_ops'})
    op.create_index('ix_chat_messages_role', 'chat_messages', ['role'], unique=False)
    op.create_index('ix_chat_messages_sequence', 'chat_messages', ['session_id', 'sequence_number'], unique=False)
    op.create_index(op.f('ix_chat_messages_session_id'), 'chat_messages', ['session_id'], unique=False)
    op.create_index('ix_chat_messages_timestamp', 'chat_messages', ['timestamp'], unique=False)
    op.create_index('ix_chat_messages_translated_gin', 'chat_messages', ['translated_content'], unique=False, postgresql_using='gin')
    ...
    op.create_index('ix_conv_stats_calculated_at', 'conversation_statistics', ['calculated_at'], unique=False)
    op.create_index('ix_conv_stats_session_id', 'conversation_statistics', ['session_id'], unique=False)
    ...
    op.create_index('ix_domain_usage_domain_date', 'domain_usage_logs', ['domain_id', 'created_at'], unique=False)
    op.create_index(op.f('ix_domain_usage_logs_created_at'), 'domain_usage_logs', ['created_at'], unique=False)
    ...
    op.alter_column('bot_sessions', 'bot_type',
               existing_type=sa.VARCHAR(length=50),
               server_default=None,
               existing_nullable=False)
    op.alter_column('bot_sessions', 'status',
               existing_type=sa.VARCHAR(length=50),
               server_default=None,
               existing_nullable=False)
    op.alter_column('bot_sessions', 'created_at',
               ...
               server_default=None,
               existing_nullable=False)
    op.alter_column('bot_sessions', 'enable_translation',
               existing_type=sa.BOOLEAN(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('bot_sessions', 'enable_transcription',
               existing_type=sa.BOOLEAN(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('bot_sessions', 'enable_virtual_webcam',
               existing_type=sa.BOOLEAN(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('bot_sessions', 'audio_storage_enabled',
               existing_type=sa.BOOLEAN(),
               server_default=None,
               existing_nullable=False)
    ...
    op.alter_column('glossaries', 'source_language',
               existing_type=sa.VARCHAR(length=10),
               server_default=None,
               existing_nullable=False)
    op.alter_column('glossaries', 'is_active',
               existing_type=sa.BOOLEAN(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('glossaries', 'is_default',
               existing_type=sa.BOOLEAN(),
               server_default=None,
               existing_nullable=False)
    ...
    op.alter_column('glossaries', 'updated_at',
               ...
               server_default=None,
               existing_nullable=False)
    op.alter_column('glossaries', 'entry_count',
    ...
    op.alter_column('glossary_entries', 'case_sensitive',
               existing_type=sa.BOOLEAN(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('glossary_entries', 'match_whole_word',
               existing_type=sa.BOOLEAN(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('glossary_entries', 'priority',
               existing_type=sa.INTEGER(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('glossary_entries', 'created_at',
               existing_type=postgresql.TIMESTAMP(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('glossary_entries', 'updated_at',
               existing_type=postgresql.TIMESTAMP(),
               server_default=None,
               existing_nullable=False)
    op.create_index(op.f('ix_glossary_entries_source_term_normalized'), 'glossary_entries', ['source_term_normalized'], unique=False)
    op.create_index('idx_participants_speaker_id', 'participants', ['speaker_id'], unique=False)
    op.alter_column('session_events', 'timestamp',
               existing_type=postgresql.TIMESTAMP(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('session_events', 'severity',
               existing_type=sa.VARCHAR(length=20),
               server_default=None,
               existing_nullable=False)
    op.alter_column('session_statistics', 'total_participants',
               existing_type=sa.INTEGER(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('session_statistics', 'total_audio_files',
               existing_type=sa.INTEGER(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('session_statistics', 'total_transcripts',
               existing_type=sa.INTEGER(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('session_statistics', 'total_translations',
               existing_type=sa.INTEGER(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('session_statistics', 'total_correlations',
               existing_type=sa.INTEGER(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('session_statistics', 'total_words',
               existing_type=sa.INTEGER(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('session_statistics', 'total_characters',
               existing_type=sa.INTEGER(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('session_statistics', 'unique_speakers',
               existing_type=sa.INTEGER(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('session_statistics', 'calculated_at',
               existing_type=postgresql.TIMESTAMP(),
               server_default=None,
               existing_nullable=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_chat_messages_translated_gin', table_name='chat_messages', postgresql_using='gin')
    ...
    op.drop_index('ix_chat_messages_content_fulltext', table_name='chat_messages', postgresql_using='gin', postgresql_ops={'content': 'gin_trgm_ops'})
    ...
    op.drop_index('ix_conv_sessions_metadata_gin', table_name='conversation_sessions', postgresql_using='gin')
