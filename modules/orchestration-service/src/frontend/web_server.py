...
class WebServer:
    ...
    def render_404(self) -> str:
        ...
        try:
            ...
            return self._render_error_page("404 Not Found", "The requested page could not be found.")
    ...
    def get_frontend_config(self) -> Dict[str, Any]:
        ...
        return {
            "services": {
                ...
                "translation": {
                    "url": os.getenv('TRANSLATION_SERVICE_URL', 'http://localhost:5003'),
                    "features": ["translation", "language_detection", "local_inference"]
                },
                "orchestration": {
                    "url": f"http://localhost:{self.port}",
                    "features": ["routing", "load_balancing", "monitoring", "session_management"]
                }
            },
            "ui": {
...
def add_web_routes(app: Flask, web_server: WebServer):
            ...
            if request.files:
                for key, file in request.files.items():
                    ...
                    try:
                        ...
                        logger.info(f"[DEBUG] File {key}: {file.filename} ({file_size} bytes, {file.content_type})")
    ...
    def internal_error(error):
        ...
        if request.path.startswith('/api/'):
            ...
            return web_server._render_error_page("Internal Server Error", "An internal server error occurred."), 500