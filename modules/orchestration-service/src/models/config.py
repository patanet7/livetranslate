...
class ConfigDiff(BaseModel):
    ...
    added: Dict[str, Any] = Field(
        default_factory=dict, description="Added configuration keys"
    )
...
class FeatureFlags(BaseModel):
    ...
    enable_bot_management: bool = Field(
        default=True, description="Enable bot management features"
    )
    enable_translation: bool = Field(
        default=True, description="Enable translation features"
    )
