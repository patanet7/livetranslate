            ...
            if self.performance_target.target_latency_ms:
                if processing_time_ms > self.performance_target.target_latency_ms:
                    performance_warnings.append({
                        ...
                        "exceeded_by_ms": processing_time_ms - self.performance_target.target_latency_ms
                    })
            ...
            if self.performance_target.max_latency_ms:
                if processing_time_ms > self.performance_target.max_latency_ms:
                    performance_warnings.append({
                        ...
                        "exceeded_by_ms": processing_time_ms - self.performance_target.max_latency_ms
                    })
...
class ModularAudioPipeline:
    ...
    def process_chunk(self, audio_data: np.ndarray, stop_after_stage: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def process_single_stage(self, stage_name: str, audio_data: np.ndarray) -> Optional[StageResult]:
