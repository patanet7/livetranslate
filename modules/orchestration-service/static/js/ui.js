...
const UI = {
    ...
    updateModelSelection(modelName) {
        ...
        modelItems.forEach(item => {
            ...
            if (item.querySelector('span') && item.querySelector('span').textContent === modelName) {
                item.classList.add('selected');
            }
        });
        
        // Update dropdown selection
        if (elements.selectedModel && elements.selectedModel.value !== modelName) {
        ...
        addLog('DEBUG', `Model selection updated to: ${modelName}`);
    },
