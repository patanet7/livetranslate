...
chinese_audio2, cn_sr2 = librosa.load('../whisper-service/tests/fixtures/audio/OSR_cn_000_0073_8k.wav', sr=None, mono=True)
if cn_sr2 != 16000:
...
print(f"  EN: 'And so, my fellow Americans, ask not what your country can do for you, ask what you can do for your country.'")
