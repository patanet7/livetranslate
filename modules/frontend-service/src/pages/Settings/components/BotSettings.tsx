  ...
  return (
    <Box>
      ...
      <Alert severity="info" sx={{ mb: 3 }}>
        Configure Google Meet bot management including spawning, lifecycle,
        audio capture, and database integration. Supports enterprise-grade bot
        orchestration with automatic recovery.
      </Alert>
          ...
          <Grid container spacing={3}>
              ...
              <FormControlLabel
                control={
                  <Switch
                    ...
                    onChange={(e) =>
                      handleConfigChange("manager", "enabled", e.target.checked)
                    }
                  />
                }
            ...
            <Grid item xs={12} md={6}>
              <Typography gutterBottom>
                Max Concurrent Bots: {config.manager.max_concurrent_bots}
              </Typography>
              <Slider
                value={config.manager.max_concurrent_bots}
                onChange={(_, value) =>
                  handleConfigChange("manager", "max_concurrent_bots", value)
                }
                min={1}
                max={50}
                step={1}
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              <Typography gutterBottom>
                Quality Threshold: {config.audio_capture.quality_threshold}
              </Typography>
              <Slider
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              <Typography gutterBottom>
                CPU Limit: {config.performance.cpu_limit_percent}%
              </Typography>
              <Slider
                value={config.performance.cpu_limit_percent}
                onChange={(_, value) =>
                  handleConfigChange("performance", "cpu_limit_percent", value)
                }
                min={10}
                max={100}
                step={10}
