...
const CaptionOverlayPage: React.FC = () => {
  ...
  const config = useMemo(() => {
    ...
    const position = (searchParams.get("position") || "bottom") as
      | "top"
      | "center"
      | "bottom";
      ...
      <div style={containerStyle}>
        ...
        >
          <h2 style={{ marginBottom: "20px" }}>
            Caption Overlay - Browser Source
          </h2>
          <p style={{ marginBottom: "10px" }}>
            Add <code>?session=YOUR_SESSION_ID</code> to the URL
          </p>
          <p style={{ fontSize: "14px", opacity: 0.8, marginTop: "20px" }}>
            Example:
            /caption-overlay?session=meeting-123&amp;lang=es&amp;fontSize=24
          </p>
          <div
          ...
          >
            ...
            <ul style={{ listStyleType: "none", padding: 0 }}>
              <li>
                • <strong>session</strong> - Session ID (required)
              </li>
              <li>
                • <strong>lang</strong> - Target language filter
              </li>
              <li>
                • <strong>showSpeaker</strong> - Show speaker names (true/false)
              </li>
              <li>
                • <strong>showOriginal</strong> - Show original text
                (true/false)
              </li>
              <li>
                • <strong>fontSize</strong> - Font size in pixels
              </li>
              <li>
                • <strong>position</strong> - top, center, or bottom
              </li>
              <li>
                • <strong>maxCaptions</strong> - Max visible captions
              </li>
              <li>
                • <strong>bg</strong> - Background color (CSS)
              </li>
            </ul>
          </div>
        </div>
