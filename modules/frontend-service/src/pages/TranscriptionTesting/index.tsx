...
const TranscriptionTesting: React.FC = () => {
  ...
  const { isConnected: webSocketConnected } = useAppSelector(
  ...
  const startStreaming = useCallback(async () => {
    try {
      ...
      notifySuccess(
        "Streaming Started",
        `Started streaming with ${transcriptionSettings.chunkDuration}s chunks`,
      );
    } catch (error) {
  ...
  const processAudio = useCallback(
    async (audioBlob: Blob) => {
      ...
      try {
        ...
        formData.append(
          "enable_diarization",
          transcriptionSettings.enableDiarization.toString(),
        );
        formData.append("whisper_model", transcriptionSettings.whisperModel);
        formData.append(
          "enable_vad",
          transcriptionSettings.enableVAD.toString(),
        );
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Typography variant="subtitle1" color="text.secondary" gutterBottom>
        Comprehensive audio transcription testing with real-time streaming and
        detailed analysis
      </Typography>
              ...
              <Stack spacing={2}>
                ...
                <Box>
                  <Typography variant="body2" gutterBottom>
                    ...
                    {audioLevel < 5 &&
                      " ⚠️ Signal too weak - check audio settings"}
                    {audioLevel > 5 &&
                      audioLevel < 20 &&
                      " ✓ Good signal level"}
                  ...
                  {audioLevel < 5 && (
                    ...
                    >
                      Try disabling audio processing options below or speaking
                      louder
                    </Typography>
                  )}
                </Box>
                ...
                <Box sx={{ display: "flex", gap: 2 }}>
                  ...
                  >
                    {isStreaming
                      ? `Stop Streaming (${chunkCount} chunks)`
                      : "Start Streaming"}
                  </Button>
                </Box>
            ...
            <CardContent>
              ...
              <Stack spacing={2}>
                ...
                <Alert severity="info">
                  ...
                  <br />• For microphone input: Enable echo cancellation and
                  noise suppression
                  <br />• For system/loopback audio: Disable all processing for
                  better signal capture
                  <br />• If audio levels are very low, try disabling all
                  processing options
                </Alert>
              </Stack>
            </CardContent>
          ...
          <Grid item xs={12}>
            <Card>
              <CardContent>
                ...
                <Paper
                  sx={{ p: 2, minHeight: 100, backgroundColor: "grey.50" }}
                >
                ...
                <Paper sx={{ p: 2, mb: 2, backgroundColor: "primary.50" }}>
                  ...
                  <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap" }}>
                    ...
                    <Chip
                      ...
                      size="small"
                      color={
                        currentTranscription.confidence > 0.8
                          ? "success"
                          : "warning"
                      }
                    />
          ...
          <Card>
            <CardContent>
              ...
              {transcriptionResults.length > 0 ? (
                ...
                <Alert severity="info">
                  Start recording or streaming to see transcription results
                  here.
                </Alert>
              )}
            </CardContent>
