...
export const BotSpawner: React.FC<BotSpawnerProps> = ({ onBotSpawned, onError }) => {
      ...
      <CardContent>
        ...
        <Box sx={{ mt: 3, pt: 2, borderTop: '1px solid', borderColor: 'divider' }}>
          ...
          <Stack direction="row" spacing={1} flexWrap="wrap">
            ...
            <Button
              size="small"
              variant="outlined"
              onClick={() => setFormData(prev => ({ ...prev, targetLanguages: ['en', 'es', 'fr'] }))}
            >
              Multi-Language
            </Button>
            <Button
        ...
        <Alert severity="info" sx={{ mt: 2 }}>
          <Typography variant="body2">
            Bot will join the meeting, capture audio, process captions, and generate real-time translations.
            Virtual webcam will display translations overlaid on the video feed.
          </Typography>
        </Alert>
      </CardContent>
    </Card>
