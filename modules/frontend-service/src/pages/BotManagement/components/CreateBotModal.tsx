    ...
    switch (step) {
      case 0:
        if (!formData.meetingId.trim()) {
          ...
          !/^[a-zA-Z0-9-_]+$/.test(
            formData.meetingId.replace(/https?:\/\/meet\.google\.com\//, ""),
          )
        ) {
        ...
        return (
          <Stack spacing={3}>
            <TextField
              ...
              helperText={
                errors.meetingId ||
                "Enter meet ID (e.g., abc-defg-hij) or full URL"
              }
          ...
          <Stack spacing={3}>
            ...
            <Alert severity="info">
              <Typography variant="body2">
                High priority bots will use more system resources but provide
                better real-time performance. Medium priority is recommended for
                most use cases.
              </Typography>
            </Alert>
          </Stack>
        ...
        return (
          <Stack spacing={3}>
            <Alert severity="success">
              ...
              <Typography variant="body2">
                Please review the configuration below and click "Create Bot" to
                proceed.
              </Typography>
            </Alert>
