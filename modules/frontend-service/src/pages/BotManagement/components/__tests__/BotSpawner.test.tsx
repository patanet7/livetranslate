...
describe("BotSpawner", () => {
  ...
  describe("initial render", () => {
    it("should render the bot spawner form", () => {
      ...
      expect(
        screen.getByRole("button", { name: /spawn bot/i }),
      ).toBeInTheDocument();
    });
    ...
    it("should have default form values", () => {
      ...
      const meetingIdInput = screen.getByLabelText(
        /Google Meet ID/i,
      ) as HTMLInputElement;
      const meetingTitleInput = screen.getByLabelText(
        /Meeting Title/i,
      ) as HTMLInputElement;
      const organizerEmailInput = screen.getByLabelText(
        /Organizer Email/i,
      ) as HTMLInputElement;
      const autoTranslationSwitch = screen.getByRole("checkbox", {
        name: /Enable Auto-Translation/i,
      }) as HTMLInputElement;
  ...
  describe("form interactions", () => {
    ...
    it("should change bot priority", async () => {
      ...
      const highPriorityOption = screen.getByText(
        /High - Real-time processing/i,
      );
  ...
  describe("language selection", () => {
    it("should allow toggling language chips", async () => {
      ...
      expect(frenchChip.closest(".MuiChip-root")).toHaveClass(
        "MuiChip-outlined",
      );
    ...
    it("should update selected languages display", async () => {
      ...
      const selectedLanguagesSection = screen.getByText(
        "Selected Languages:",
      ).parentElement;
  ...
  describe("quick actions", () => {
    it("should have quick action buttons", () => {
      ...
      expect(
        screen.getByRole("button", { name: /demo meeting/i }),
      ).toBeInTheDocument();
      expect(
        screen.getByRole("button", { name: /multi-language/i }),
      ).toBeInTheDocument();
      expect(
    ...
    it("should apply multi-language setup on quick action click", async () => {
      ...
      const multiLangButton = screen.getByRole("button", {
        name: /multi-language/i,
      });
