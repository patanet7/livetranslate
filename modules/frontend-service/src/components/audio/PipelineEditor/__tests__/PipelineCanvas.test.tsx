...
describe('PipelineCanvas', () => {
  ...
  describe('Pipeline Callbacks', () => {
    it('should call onPipelineChange when nodes are added', async () => {
      ...
      const { rerender } = renderPipelineCanvas({ initialPipeline, onPipelineChange });
  ...
  describe('Edge Type Memoization', () => {
    it('should memoize edge types to prevent re-creation', async () => {
      ...
      const { rerender } = renderPipelineCanvas({ initialPipeline, isRealtimeActive: false });

      // Re-render with same isRealtimeActive - edge types should be memoized
      rerender(
        <ReactFlowProvider>
          <PipelineCanvas {...defaultProps} initialPipeline={initialPipeline} isRealtimeActive={false} />
        </ReactFlowProvider>
      );
      ...
      rerender(
        <ReactFlowProvider>
          <PipelineCanvas {...defaultProps} initialPipeline={initialPipeline} isRealtimeActive={true} />
        </ReactFlowProvider>
      );
