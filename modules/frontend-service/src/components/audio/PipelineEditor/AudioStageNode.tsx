          ...
          <Box display="flex" alignItems="center" gap={1}>
            ...
            >
              {data.icon && typeof data.icon === "function" ? (
                React.createElement(data.icon as any, {
                  style: { fontSize: 16 },
                })
              ) : (
          ...
          <Box display="flex" gap={1}>
            ...
            <Box flex={1}>
              ...
              <Slider
                ...
                size="small"
                onChange={(_, value) =>
                  onGainChange(id, "out", value as number)
                }
                onMouseDown={(e) => e.stopPropagation()}
                onClick={(e) => e.stopPropagation()}
                sx={{
        ...
        {data.metrics && (
          <Box mb={1.5}>
            ...
            <LinearProgress
              variant="determinate"
              value={Math.min(
                (data.metrics.processingTimeMs / data.metrics.targetLatencyMs) *
                  100,
                100,
              )}
              sx={{
                ...
                {data.parameters.slice(0, 3).map((param) => (
                  <Box key={param.name} mb={1}>
                    ...
                    <Slider
                      ...
                      size="small"
                      onChange={(_, value) =>
                        onParameterChange(id, param.name, value as number)
                      }
                      sx={{
                        color: colors.primary,
                        "& .MuiSlider-thumb": {
