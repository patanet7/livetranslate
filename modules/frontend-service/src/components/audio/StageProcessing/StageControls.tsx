...
import { VolumeUp, VolumeDown, Refresh, Tune } from "@mui/icons-material";
...
const STAGE_PARAMETERS: Record<string, StageParameter[]> = {
  vad: [
    ...
    },
    {
      ...
      step: 0.001,
      defaultValue: 0.01,
      description: "Voice detection threshold",
    },
    {
      key: "voice_freq_min",
      label: "Min Voice Freq",
      type: "slider",
      min: 50,
      max: 150,
      step: 5,
  ...
  voice_filter: [
    ...
    {
      key: "voice_band_gain",
      label: "Voice Band Gain",
      type: "slider",
      min: 0.1,
      max: 3.0,
      step: 0.1,
      defaultValue: 1.1,
      description: "Voice frequency amplification",
    },
    {
      key: "preserve_formants",
      label: "Preserve Formants",
      type: "switch",
      defaultValue: true,
      description: "Maintain F1/F2 formant frequencies",
    },
  ],
  noise_reduction: [
    {
    ...
    {
      key: "voice_protection",
      label: "Voice Protection",
      type: "switch",
      defaultValue: true,
      description: "Protect speech frequencies",
    },
    {
      key: "adaptation_rate",
      ...
      step: 0.01,
      defaultValue: 0.1,
      description: "Noise profile adaptation speed",
    },
    {
      key: "noise_floor_db",
      label: "Noise Floor",
  ...
  voice_enhancement: [
    ...
    },
    {
      ...
      step: 0.1,
      defaultValue: 0.1,
      description: "2-5kHz presence boost",
    },
    {
      key: "warmth_adjustment",
      label: "Warmth",
      type: "slider",
      min: -1.0,
      max: 1.0,
      step: 0.1,
      defaultValue: 0.0,
      description: "Tonal warmth adjustment",
    },
    {
      key: "brightness_adjustment",
      label: "Brightness",
      type: "slider",
      min: -1.0,
      max: 1.0,
      step: 0.1,
      defaultValue: 0.0,
      description: "High frequency brightness",
    },
  ],
  equalizer: [
    {
  ...
  spectral_denoising: [
    ...
    },
    {
      ...
      step: 0.1,
      defaultValue: 0.1,
      description: "Artifact reduction floor",
    },
  ],
  conventional_denoising: [
    ...
    {
      key: "preserve_transients",
      label: "Preserve Transients",
      type: "switch",
      defaultValue: true,
      description: "Maintain speech transients",
    },
  ],
  lufs_normalization: [
    {
      ...
      defaultValue: -23,
      unit: "LUFS",
      description: "EBU R128 standard: -23 LUFS",
    },
    {
      key: "max_adjustment",
  ...
  limiter: [
    ...
    },
    {
      ...
      type: "switch",
      defaultValue: true,
      description: "Harmonic saturation vs hard clipping",
    },
  ],
};
      ...
      <CardContent>
        ...
        <Alert severity="info" sx={{ mb: 3 }}>
          ...
          <Typography variant="body2">
            Professional gain controls (-20dB to +20dB) applied before and after
            stage processing
          </Typography>
        </Alert>
          ...
          <Grid item xs={6}>
            <Box>
              ...
              <Slider
                ...
                step={0.1}
                onChange={(_, value) =>
                  handleGainChange("out", value as number)
                }
                valueLabelDisplay="auto"
                valueLabelFormat={(value) =>
                  `${value > 0 ? "+" : ""}${value}dB`
        ...
        {stageParameters.length > 0 ? (
          <Box>{stageParameters.map(renderParameter)}</Box>
        ) : (
          <Typography
            variant="body2"
            color="text.secondary"
        ...
        <Box mt={3} p={2} bgcolor="background.default" borderRadius={1}>
          ...
          >
            {JSON.stringify(
              { gain_in: gainIn, gain_out: gainOut, ...config },
              null,
              2,
            )}
          </Typography>
