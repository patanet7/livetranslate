...
const QUALITY_CATEGORIES: Record<
  string,
  {
    name: string;
    description: string;
...
export const QualityMetrics: React.FC<QualityMetricsProps> = ({
  ...
  const handleDownloadReport = () => {
    ...
    const report = {
      ...
      category_breakdown: Object.entries(currentMetrics.category_scores).map(
        ([key, score]) => ({
          category:
            QUALITY_CATEGORIES[key as keyof typeof QUALITY_CATEGORIES]?.name ||
            key,
          score,
          status: getScoreStatus(
            score,
            QUALITY_CATEGORIES[key as keyof typeof QUALITY_CATEGORIES] || {},
          ),
          threshold_met:
            score >=
            (QUALITY_CATEGORIES[key as keyof typeof QUALITY_CATEGORIES]
      ...
      recommendations: currentMetrics.improvement_suggestions
        .map((rec) => ({
          ...rec,
          priority_score:
      ...
      compliance: {
        ...
        lufs_current:
          audioData.quality_analysis.lufs_compliance.integrated_lufs,
        lufs_target: audioData.quality_analysis.lufs_compliance.target_lufs,
        adjustment_needed:
          audioData.quality_analysis.lufs_compliance.adjustment_needed_db,
      },
    ...
    return (
      <Card sx={{ height: "100%" }}>
        <CardContent>
          ...
          <Alert severity="info">
            No audio data available for quality analysis. Start audio processing
            to see comprehensive quality metrics.
          </Alert>
        </CardContent>
      </Card>
    );
        ...
        >
          ...
          <Box display="flex" alignItems="center" gap={1}>
            <Chip
              ...
              size="small"
              color={
                (currentMetrics?.overall_score ?? 0) >= targetQuality
                  ? "success"
                  : "warning"
              }
              variant="filled"
                  ...
                  <CardContent>
                    ...
                    <Box display="flex" alignItems="center" gap={2} mb={2}>
                      <Typography
                        ...
                        component="div"
                        color={getScoreColor(
                          currentMetrics?.overall_score || 0,
                        )}
                      >
                    ...
                    {showComparison && audioData.comparison_data && (
                      <Alert severity="info" sx={{ mt: 1 }}>
                        Improvement: +
                        {audioData.comparison_data.improvement_percentage.toFixed(
                          1,
                        )}
                        % from original
                      </Alert>
                ...
                <Card variant="outlined">
                  <CardContent>
                    ...
                    <Box display="flex" flexDirection="column" gap={1}>
                      {Object.entries(QUALITY_CATEGORIES).map(
                        ([key, category]) => {
                          const score =
                            currentMetrics?.category_scores[key] || 0;
                    ...
                    <Grid container spacing={2}>
                      <Grid item xs={6} md={3}>
                        ...
                        <Typography variant="h6">
                          {audioData.quality_analysis.lufs_compliance.integrated_lufs.toFixed(
                            1,
                          )}{" "}
                          LUFS
                        </Typography>
                      ...
                      <Grid item xs={6} md={3}>
                        ...
                        <Typography variant="h6">
                          {audioData.quality_analysis.lufs_compliance.target_lufs.toFixed(
                            1,
                          )}{" "}
                          LUFS
                        </Typography>
                      ...
                      <Grid item xs={6} md={3}>
                        ...
                        <Typography
                          ...
                          color={
                            Math.abs(
                              audioData.quality_analysis.lufs_compliance
                                .adjustment_needed_db,
                            ) <= 1
                              ? "success.main"
                              : "warning.main"
                          }
                        >
                          {audioData.quality_analysis.lufs_compliance
                            .adjustment_needed_db > 0
                            ? "+"
                            : ""}
                          {audioData.quality_analysis.lufs_compliance.adjustment_needed_db.toFixed(
                            1,
                          )}{" "}
                          dB
                        </Typography>
            ...
            <TableContainer component={Paper} variant="outlined">
              <Table size="small">
                <TableHead>
                  <TableRow>
                    <TableCell>
                      <strong>Technical Metric</strong>
                    </TableCell>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell align="right">
                      {audioData.quality_analysis.technical_metrics.snr_db.toFixed(
                        1,
                      )}
                    </TableCell>
                    ...
                    <TableCell>
                      <Chip
                        label={
                          audioData.quality_analysis.technical_metrics.snr_db >=
                          20
                            ? "Excellent"
                            : audioData.quality_analysis.technical_metrics
                                  .snr_db >= 15
                              ? "Good"
                              : audioData.quality_analysis.technical_metrics
                                    .snr_db >= 10
                  ...
                  <TableRow>
                    ...
                    <TableCell align="right">
                      {audioData.quality_analysis.technical_metrics.thd_percentage.toFixed(
                        2,
                      )}
                    </TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell align="right">
                      {audioData.quality_analysis.technical_metrics.peak_to_rms_ratio.toFixed(
                        1,
                      )}
                    </TableCell>
                    <TableCell align="right">dB</TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell align="right">
                      {audioData.quality_analysis.technical_metrics.crest_factor.toFixed(
                        1,
                      )}
                    </TableCell>
                    <TableCell align="right">dB</TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell align="right">
                      {audioData.quality_analysis.technical_metrics.spectral_centroid.toFixed(
                        0,
                      )}
                    </TableCell>
              ...
              {audioData.quality_analysis.recommendations.length === 0 ? (
                <Alert severity="success">
                  <Typography variant="body1">
                    No quality issues detected. Audio meets all quality
                    thresholds.
                  </Typography>
                </Alert>
              ) : (
                    ...
                    <AccordionDetails>
                      ...
                      >
                        ...
                        <Typography variant="caption" color="success.main">
                          ...
                          {rec.estimated_improvement.toFixed(1)} points
                        </Typography>
                      </Box>
                    </AccordionDetails>
                  </Accordion>
                ...
                <Grid item xs={12} md={6}>
                  ...
                  >
                    <Typography variant="body2" gutterBottom>
                      ...
                      {
                        qualityHistory.filter(
                          (h) => h.overall_score >= targetQuality,
                        ).length
                      }
                      /{qualityHistory.length}
                    </Typography>
                    <Typography variant="body2" gutterBottom>
                      ...
                      Best score:{" "}
                      {Math.max(
                        ...qualityHistory.map((h) => h.overall_score),
                      ).toFixed(1)}
                      /10.0
                    </Typography>
                    <Typography variant="body2" gutterBottom>
          ...
          <Box mt={2}>
            ...
            <TableContainer component={Paper} variant="outlined">
              <Table size="small">
                ...
                <TableBody>
                  {audioData.comparison_data.stage_contributions.map(
                    (stage, index) => (
                      <TableRow key={index}>
                        ...
                        <TableCell align="right">
                          <Typography
                            variant="body2"
                            color={
                              stage.quality_impact >= 0
                                ? "success.main"
                                : "error.main"
                            }
                          >
                            {stage.quality_impact >= 0 ? "+" : ""}
                            {stage.quality_impact.toFixed(2)}
                          </Typography>
                        </TableCell>
                        <TableCell align="right">
                          {stage.processing_time_ms.toFixed(1)}ms
                        </TableCell>
                        <TableCell align="right">
                          <Chip
                            ...
                            size="small"
                            color={
                              stage.effectiveness_score >= 0.8
                                ? "success"
                                : stage.effectiveness_score >= 0.6
                                  ? "info"
                                  : stage.effectiveness_score >= 0.4
                                    ? "warning"
                                    : "error"
                            }
                          />
