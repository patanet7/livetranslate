...
const uiSlice = createSlice({
  ...
  reducers: {
    ...
    updateDashboardPreferences: (
      state,
      action: PayloadAction<Partial<UIState["dashboard"]>>,
    ) => {
    ...
    updateAudioTestingPreferences: (
      state,
      action: PayloadAction<Partial<UIState["audioTesting"]>>,
    ) => {
      Object.assign(state.audioTesting, action.payload);
    },

    toggleAudioAdvancedControls: (state) => {
      state.audioTesting.showAdvancedControls =
        !state.audioTesting.showAdvancedControls;
    },

    setAudioVisualizationType: (
      state,
      action: PayloadAction<"waveform" | "frequency" | "level">,
    ) => {
    ...
    updateBotManagementPreferences: (
      state,
      action: PayloadAction<Partial<UIState["botManagement"]>>,
    ) => {
    ...
    setBotSortBy: (
      state,
      action: PayloadAction<UIState["botManagement"]["sortBy"]>,
    ) => {
